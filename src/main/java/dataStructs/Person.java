...
public class Person implements DatabaseEntity {
    ...
    public static class Fields {
        ...
        public static Country enterCounty(Scanner scanner, Consumer<String> standardOut, Consumer<String> errorOut) {
            standardOut.accept("Enter nationality of group admin (Country or null): ");
            standardOut.accept("Choose one of following: " + StudyGroup.Fields.getEnumOptions(Country.class) +" | null");
